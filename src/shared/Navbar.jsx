...
const Navbar = () => {
  ...
  return (
    <nav className="w-full sticky top-0 z-50">
      {/* Top Bar */}
      <div className="bg-[#1e2d5a] text-white/80 py-2 px-6 hidden sm:block">
        <div className="max-w-6xl mx-auto flex justify-between items-center text-[11px] font-semibold uppercase tracking-wider">
          <div className="flex gap-6">
            <div className="flex items-center gap-2">
              <HiOutlinePhone className="text-[#e87722] w-3.5 h-3.5" />
              <span>+234 800 000 0000</span>
            </div>
            <div className="flex items-center gap-2">
              <HiOutlineMail className="text-[#e87722] w-3.5 h-3.5" />
              <span>info@mellesserv.com</span>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <HiOutlineClock className="text-[#e87722] w-3.5 h-3.5" />
      ...
      {/* Main Nav */}
      <div className="bg-white border-b border-gray-100 shadow-sm p-4">
    ...
    {[
      ...
      <NavLink
        key={link.label}
                ...
                className={({ isActive }) =>
                  `font-bold text-sm ${isActive ? "text-[#1e2d5a]" : "text-[#e87722]"} transition-colors`
                }
              >
                {link.label}
              </NavLink>
