...
export const services = [
  {
    id: 'procurement',
    title: 'Procurement & General Contracting',
    shortDesc:
      'End-to-end procurement solutions and reliable contract execution.',
    icon: '🏗️',
    ...
    overview: `Melles Serv delivers comprehensive procurement and general contracting 
    services tailored to meet the demands of modern industry. We manage the full 
    supply chain — from vendor sourcing to final delivery — ensuring quality, 
    compliance, and cost efficiency at every step.`,

    highlights: [
      'Vendor identification, vetting & management',
    ...
    stats: [
      ...
      { label: 'Vendor Partners', value: '80+' },
