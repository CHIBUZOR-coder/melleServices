...
const pillars = [
  {
    ...
    desc: "A decade of delivering results across procurement, logistics, and energy.",
  },
  {
    icon: "🔧",
    title: "End-to-End Solutions",
    desc: "From tendering to training — one partner for every stage.",
  },
  {
    icon: "📍",
    title: "Local Expertise",
    desc: "Deep knowledge of Nigeria's supply chains and energy sector.",
  },
  {
    icon: "🤝",
    title: "Client-First Approach",
    desc: "Every solution is tailored — we listen first, then deliver.",
  },
];
