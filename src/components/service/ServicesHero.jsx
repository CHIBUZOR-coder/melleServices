...
export default function ServicesHero() {
  return (
    <section className="relative bg-[#1e2d5a] overflow-hidden min-h-[420px] flex items-center">
      {/* Background pattern — matches AboutHero */}
      <div
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 w-full">
        ...
        >
          Services Built for{" "}
          <span className="text-[#e87722]">Real Industry.</span>
        </motion.h1>
        ...
        >
          From petroleum supply to professional training — Melles Serv delivers
          end-to-end solutions across six core sectors of Nigeria's economy.
        </motion.p>
